  ...
  return (
    <section className="relative overflow-hidden px-5 pt-32 pb-20 sm:px-8 md:px-10">
      <div className="mx-auto max-w-4xl text-center">
        ...
        >
          Modernize how your business runs, end to end.
        </motion.h1>
        ...
        >
          Friday helps you move off spreadsheets, legacy systems, and manual
          processes — replacing them with a connected digital foundation.
        </motion.p>
