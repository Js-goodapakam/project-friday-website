...
const STEPS = [
  {
    number: "01",
    title: "Assess",
    body: "We map your current systems and processes to see what's actually slowing you down.",
  },
  {
    number: "02",
    title: "Modernize",
    body: "Legacy tools and manual steps get replaced with a connected digital setup.",
  },
  {
    number: "03",
    title: "Grow",
    body: "Your new foundation scales with the business, instead of holding it back.",
  },
];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          <h2 className="text-[30px] font-semibold leading-tight tracking-tight text-white sm:text-[36px]">
            From legacy systems to a modern foundation.
          </h2>
        </motion.div>
