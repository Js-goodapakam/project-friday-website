...
const STEPS = [
  {
    number: "01",
    title: "Map",
    body: "We map out the repetitive steps your team does every day — the ones nobody enjoys.",
  },
  {
    number: "02",
    title: "Automate",
    body: "Friday builds the workflow, connecting your tools and handling the handoffs automatically.",
  },
  {
    number: "03",
    title: "Scale",
    body: "As your business grows, the same automations keep running — no extra headcount needed.",
  },
];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          <h2 className="text-[30px] font-semibold leading-tight tracking-tight text-white sm:text-[36px]">
            From manual process to running itself.
          </h2>
        </motion.div>
