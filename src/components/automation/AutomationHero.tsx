  ...
  return (
    <section className="relative overflow-hidden px-5 pt-32 pb-20 sm:px-8 md:px-10">
      <div className="mx-auto max-w-4xl text-center">
        ...
        >
          Let Friday handle the busywork.
        </motion.h1>
        ...
        >
          From repetitive tasks to multi-step workflows, Friday automates the
          work that slows your team down — so people spend time on decisions,
          not data entry.
        </motion.p>
