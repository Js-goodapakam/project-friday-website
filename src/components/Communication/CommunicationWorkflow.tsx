...
const STEPS = [
  {
    number: "01",
    title: "Connect",
    body: "Your phone lines, inbox, and chat all connect into Friday — no new number to learn.",
  },
  {
    number: "02",
    title: "Respond",
    body: "Messages route to the right person automatically, with full context attached.",
  },
  {
    number: "03",
    title: "Resolve",
    body: "Conversations stay open until they're actually done — nothing quietly forgotten.",
  },
];
...
export default function CommunicationWorkflow() {
  return (
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          <h2 className="text-[30px] font-semibold leading-tight tracking-tight text-white sm:text-[36px]">
            From scattered channels to one conversation.
          </h2>
        </motion.div>
