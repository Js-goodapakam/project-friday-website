...
export default function CommunicationCTA() {
  return (
    <section className="px-5 py-24 sm:px-8 md:px-10">
      ...
      >
        <h2 className="text-[26px] font-semibold leading-tight tracking-tight text-ink sm:text-[32px]">
          Ready to bring every conversation into one place?
        </h2>
        <p className="mt-3 text-[15px] leading-relaxed text-ink/55">
          See how Friday connects your calls, chat, and email into a single view for your team.
        </p>
        <Link
          to="/contact"
