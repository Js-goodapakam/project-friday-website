  ...
  return (
    <section className="relative overflow-hidden px-5 pt-32 pb-20 sm:px-8 md:px-10">
      <div className="mx-auto max-w-4xl text-center">
        ...
        >
          Every conversation, on every channel, in one inbox.
        </motion.h1>
        ...
        >
          Calls, chat, email, and SMS — Friday brings every customer
          conversation into one place, so your team never loses the thread.
        </motion.p>
