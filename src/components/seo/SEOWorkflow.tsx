...
const STEPS = [
  {
    number: "01",
    title: "Audit",
    body: "We find out exactly where your site stands and what's holding your rankings back.",
  },
  {
    number: "02",
    title: "Optimize",
    body: "Content, structure, and technical fixes go in, targeted at the terms that matter.",
  },
  {
    number: "03",
    title: "Grow",
    body: "Rankings and traffic climb over time, tracked with clear, honest reporting.",
  },
];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          <h2 className="text-[30px] font-semibold leading-tight tracking-tight text-white sm:text-[36px]">
            From invisible on Google to hard to miss.
          </h2>
        </motion.div>
